...
<head>
    ...
    <title>{{ __('Sign-in could not be completed') }}</title>
    <style>
...
<body>
    <div class="card">
        <h1>{{ __('Sign-in could not be completed') }}</h1>
        <p>{{ __('The identity provider could not complete your sign-in. Please try again.') }}</p>
